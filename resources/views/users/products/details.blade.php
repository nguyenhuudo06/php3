                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded">
                                <a href="#">
                                    <img src="{{ $data['data']['details']->feature_image_path }}" class="img-fluid rounded" alt="Image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <h4 class="fw-bold mb-3">{{ $data['data']['details']->name }}</h4>
                            <p class="mb-3">{{ $data['data']['details']->category_id }}</p>
            ...
            <div class="vesitable">
                <div class="owl-carousel vegetable-carousel justify-content-center owl-loaded owl-drag">
                    ...
                    <div class="owl-stage-outer">
                        <div class="owl-stage"
                            style="transform: translate3d(-1321px, 0px, 0px); transition: all 1.5s ease 0s; width: 5284px;">
