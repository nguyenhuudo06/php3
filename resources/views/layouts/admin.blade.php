...
<head>
    ...
    <title>{{ $data['config']['title'] ?? 'Admin' }}</title>
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/css/dataTables.bootstrap4.css') }}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/css/adminlte.min.css') }}">
    <!-- Google Font: Source Sans Pro -->
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
    <!-- Summernote -->
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/css/summernote-bs4.css') }}">
    <!-- Sweetalert2 -->
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/css/adminlte.min.css') }}">
    <!-- Custom css -->
...
<body class="hold-transition sidebar-mini">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        {{-- <img src="/public/assets/admin/images/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image"> --}}
                    </div>
                    <div class="info">
    ...
    <!-- DataTables -->
    <script src="{{ URL::asset('assets/admin/js/jquery.dataTables.js') }}"></script>
    <script src="{{ URL::asset('assets/admin/js/dataTables.bootstrap4.js') }}"></script>
    <!-- AdminLTE App -->
